...
<c:set var="header1" value="FusionCharts Multiseries chart using data from database"	scope="request" />
...
<fc:render chartId="${factoriesBean.chartId}" swfFilename="${folderPath}${factoriesBean.filename}" width="${factoriesBean.width}" height="${factoriesBean.height}" debugMode="false" registerWithJS="false" xmlData="${factoriesBean.xml}" useSingleQuotes="${factoriesBean.useSingleQuotes}" />
</tags:template2>